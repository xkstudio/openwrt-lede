...
$(eval $(call SetupHostCommand,gcc, \
	...
	$(CC) -dumpversion | grep -E '^(4\.[8-9]|[5-9]\.?|1[0-1]\.?)', \
	gcc -dumpversion | grep -E '^(4\.[8-9]|[5-9]\.?|1[0-1]\.?)', \
...
$(eval $(call SetupHostCommand,g++, \
	...
	$(CXX) -dumpversion | grep -E '^(4\.[8-9]|[5-9]\.?|1[0-1]\.?)', \
	g++ -dumpversion | grep -E '^(4\.[8-9]|[5-9]\.?|1[0-1]\.?)', \
...
$(eval $(call SetupHostCommand,ninja,Please install ninja, \
	ninja --version | grep '1.'))
