/*
 *  TP-LINK TL-WR720N v4 board support
 *
 *  Copyright (C) 2026 Xiaok <xiaok@openwrt.org>
 *
 */
...
static void __init tl_wr720n_v4_setup(void)
{
	...
	ath79_register_leds_gpio(-1, ARRAY_SIZE(tl_wr720n_leds_gpio), tl_wr720n_leds_gpio);
	ath79_register_gpio_keys_polled(-1, TL_WR720N_KEYS_POLL_INTERVAL, ARRAY_SIZE(tl_wr720n_gpio_keys), tl_wr720n_gpio_keys);

	gpio_request_one(TL_WR720N_GPIO_USB_POWER, GPIOF_OUT_INIT_HIGH | GPIOF_EXPORT_DIR_FIXED, "USB Power");
	ath79_register_usb();
...
MIPS_MACHINE(ATH79_MACH_TL_WR720N_V4, "TL-WR720N-v4", "TP-LINK TL-WR720N v4", tl_wr720n_v4_setup);
