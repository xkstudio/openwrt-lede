...
define Device/tl-wr890n-v1
  $(Device/tplink-16mlzma)
  DEVICE_TITLE := TP-LINK TL-WR890N v1
  BOARDNAME := TL-WR890N-v1
  DEVICE_PROFILE := TLWR890
  TPLINK_HWID := 0x08900001
endef
TARGET_DEVICES += tl-wr890n-v1
